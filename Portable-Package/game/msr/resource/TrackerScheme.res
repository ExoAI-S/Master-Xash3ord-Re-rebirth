//
//swapping 0 170 255 for 0 170 255
//swappping 0 170 255 for 196 220 255
...
Scheme
{
	...
	{
		// base colors
		"BaseText"		"196 220 255 220"	// used in text windows, lists
		"BrightBaseText"	"225 225 255 255"	// brightest text
		"SelectedText"		"255 255 255 255"	// selected text
		"DimBaseText"		"196 220 255 200"	// dim base text
		"LabelDimText"		"196 220 255 200"	// used for info text
		"ControlText"		"196 220 255 200"	// used in all text controls
		"BrightControlText"	"225 225 255 255"	// use for selected controls
...
//		"ButtonDepressedBgColor"
	...
	Fonts
	{
		...
		"Default"
		{
			"1"
			{
				"name"		"Verdana Bold" //also console
				"tall"		"13"
				"weight"	"100"
			}
		}
