...
wes_setstate_old( GLenum e, GLboolean b )
{
	...
	case GL_TEXTURE_GEN_S:
		SetUniformIndex( uEnableTextureGen[u_activetex], 0, b );
		break;
	case GL_TEXTURE_GEN_T:
		SetUniformIndex( uEnableTextureGen[u_activetex], 1, b );
		break;
	case GL_TEXTURE_GEN_R:
		SetUniformIndex( uEnableTextureGen[u_activetex], 2, b );
		break;
	case GL_TEXTURE_GEN_Q:
		SetUniformIndex( uEnableTextureGen[u_activetex], 3, b );
		break;
	case GL_CLIP_PLANE0:        SetUniform1i( uEnableClipPlane[0], b );
		break;
	case GL_CLIP_PLANE1:        SetUniform1i( uEnableClipPlane[1], b );
		break;
	case GL_CLIP_PLANE2:        SetUniform1i( uEnableClipPlane[2], b );
		break;
	case GL_CLIP_PLANE3:        SetUniform1i( uEnableClipPlane[3], b );
		break;
	case GL_CLIP_PLANE4:        SetUniform1i( uEnableClipPlane[4], b );
		break;
	case GL_CLIP_PLANE5:        SetUniform1i( uEnableClipPlane[5], b );
		break;

	case GL_LIGHTING:           SetUniform1i( uEnableLighting, b );
		break;
	case GL_LIGHT0:             SetUniform1i( uEnableLight[0], b );
		break;
	case GL_LIGHT1:             SetUniform1i( uEnableLight[1], b );
		break;
	case GL_LIGHT2:             SetUniform1i( uEnableLight[2], b );
		break;
	case GL_LIGHT3:             SetUniform1i( uEnableLight[3], b );
		break;
	case GL_LIGHT4:             SetUniform1i( uEnableLight[4], b );
		break;
	case GL_LIGHT5:             SetUniform1i( uEnableLight[5], b );
		break;
	case GL_LIGHT6:             SetUniform1i( uEnableLight[6], b );
		break;
	case GL_LIGHT7:             SetUniform1i( uEnableLight[7], b );
		break;
...
GL_MANGLE( glLightf )( GLenum light, GLenum pname, GLfloat params )
{
	...
	case GL_SPOT_EXPONENT:
		SetUniformIndex( uLight[ind].SpotVar, 0, params );
		break;
	case GL_SPOT_CUTOFF:
		SetUniformIndex( uLight[ind].SpotVar, 1, params );
		break;
	case GL_CONSTANT_ATTENUATION:
		SetUniformIndex( uLight[ind].Attenuation, 0, params );
		break;
	case GL_LINEAR_ATTENUATION:
		SetUniformIndex( uLight[ind].Attenuation, 1, params );
		break;
	case GL_QUADRATIC_ATTENUATION:
		SetUniformIndex( uLight[ind].Attenuation, 2, params );
		break;
	default:
...
GL_MANGLE( glLightfv )( GLenum light, GLenum pname, const GLfloat *params )
{
	...
	{
	case GL_AMBIENT:
		SetUniform4fv( uLight[ind].ColorAmbient, params );
		break;
	case GL_DIFFUSE:
		SetUniform4fv( uLight[ind].ColorDiffuse, params );
		break;
	case GL_SPECULAR:
		SetUniform4fv( uLight[ind].ColorSpec, params );
		break;
...
GL_MANGLE( glLightModelfv )( GLenum pname, const GLfloat *params )
{
	...
	case GL_LIGHT_MODEL_AMBIENT:
		SetUniform4fv( uLightModel.ColorAmbient, params );
		break;
	}
}
...
GL_MANGLE( glLightModeli )( GLenum pname, GLint params )
{
	...
	case GL_LIGHT_MODEL_TWO_SIDE:
		SetUniform1i( uLightModel.TwoSided, params );
		break;
	case GL_LIGHT_MODEL_LOCAL_VIEWER:
		SetUniform1i( uLightModel.LocalViewer, params );
		break;
	case GL_LIGHT_MODEL_COLOR_CONTROL:
		SetUniform1i( uLightModel.ColorControl, params );
		break;
	}
}
...
GL_MANGLE( glFogi )( GLenum pname, GLint param )
{
	...
	case GL_FOG_COORD_SRC:
		SetUniform1i( uEnableFogCoord, ( param == GL_FOG_COORD ));
		break;
	}
}
...
GL_MANGLE( glFogf )( GLenum pname, GLfloat param )
{
	...
	{
	case GL_FOG_DENSITY:
		SetUniform1f( uFogDensity, param );
		break;
	case GL_FOG_START:
		SetUniform1f( uFogStart, param );
		break;
	case GL_FOG_END:
		SetUniform1f( uFogEnd, param );
		break;
	}
}
