...
class mxToggleButton_i : public QPushButton
{
	Q_OBJECT
	mxToggleButton *d_widget;

public:
	mxToggleButton_i (QWidget *parent, mxToggleButton *widget) : QPushButton (parent)
	{
		d_widget = widget;
	}
