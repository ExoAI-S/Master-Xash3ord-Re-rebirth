...
## Master Sword: Rebirth port

This checkout contains an experimental MSR integration under `msr_port/`.
PrimeXT remains the parent SDK and MSR is opt-in:
...
See [`msr_port/README.md`](msr_port/README.md) and
[`PORTING_STATUS.md`](PORTING_STATUS.md) for the current integration boundary.
