...
Copy-Item "build\src\game\tools\scriptpack\debug\scriptpack.exe" "MSCScripts\scriptpack.exe" -Force
...
$scriptpack = Start-Process -FilePath "./scriptpack.exe" -ArgumentList "-ef" -PassThru -NoNewWindow
