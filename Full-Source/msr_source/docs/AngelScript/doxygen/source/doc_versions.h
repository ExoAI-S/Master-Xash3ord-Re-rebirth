...
\subsection doc_versions_2024 2024 - Improved JIT compiler interface and auto generated copy constructors

With version 2.37.0 the JIT compiler interface was enhanced to enable better global optimizations in JIT compiled code.

The script language also received auto generated copy constructors for script classes, and ability to indicate when default constructor, copy constructor, and value assign operator should not be generated by the compiler.

\subsection doc_versions_2025 2025 - Foreach, variadic, and template functions

With version 2.38.0 the support for foreach loops, variadic arguments, and template functions was implemented. 
