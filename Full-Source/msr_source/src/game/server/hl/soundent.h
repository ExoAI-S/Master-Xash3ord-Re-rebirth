...
enum {
	...
	bits_SOUND_WALKING = (1 << 7), // MasterSword: Just walking/moving
	bits_ALL_SOUNDS = 0xFFFFFFFF
};

enum {
	SOUNDLIST_EMPTY = -1,
	SOUNDLISTTYPE_FREE = 1, // identifiers passed to functions that can operate on either list, to indicate which list to operate on.
	SOUNDLISTTYPE_ACTIVE = 2,
	SOUND_NEVER_EXPIRE = -1 // with this set as a sound's ExpireTime, the sound will never expire.
};
//=========================================================
