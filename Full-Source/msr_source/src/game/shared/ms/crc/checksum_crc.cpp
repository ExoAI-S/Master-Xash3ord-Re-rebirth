...
void CRC32::CRC32_Init(VCRC32_t *pulCRC)
{
	*pulCRC = CRC32_INIT_VALUE;
}

void CRC32::CRC32_Final(VCRC32_t *pulCRC)
{
	*pulCRC ^= CRC32_XOR_VALUE;
}

VCRC32_t	CRC32::CRC32_GetTableEntry(unsigned int slot)
{
	return pulCRCTable[(unsigned char)slot];
}

void CRC32::CRC32_ProcessBuffer(VCRC32_t *pulCRC, const void *pBuffer, int nBuffer)
{
	VCRC32_t ulCrc = *pulCRC;
