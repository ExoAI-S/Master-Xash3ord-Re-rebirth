...
// PrimeXT's shared material ABI names the 2D vector type vec2_t.  MSR's
// original header only exposed Vector2D, so provide the compatible alias when
// both SDK header sets are compiled together.
