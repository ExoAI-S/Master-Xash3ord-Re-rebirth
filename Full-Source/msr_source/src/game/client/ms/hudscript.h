...
public:
	...
	CScript *CreateScript(const char* ScriptName, msstringlist &Parameters, bool AllowDupe = true, int UniqueID = DEFAULT_SCRIPT_ID);
	void HandleAnimEvent(const char* Options, const struct cl_entity_s *clentity, hae_e Type);
